...
//#define ENABLE_SDRT_DEBUG
#ifdef ENABLE_SDRT_DEBUG
#define DBG( x ) x
#else
#define DBG( x ) 
#endif
...
extern const char * const SDRT_CONF_FILENAME;
extern const char * const SDRT_PID_FILENAME;
...
{
    std::string s = strprintf("sdrt-%s", name);
