...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all SDRT related functionality
...
/*
    ...
    allow endless transaction that would bloat SDRT and make it unusable. To
