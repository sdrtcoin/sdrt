 ...
 * for both sdrtd and sdrt-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("SDRT Core");
...
/** 
 * Format the subversion field according to BIP 14 spec (https://github.com/sdrt/bips/blob/master/bip-0014.mediawiki) 
 */
