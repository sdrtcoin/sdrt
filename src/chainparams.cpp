...
// Copyright (c) 2017-2018 The SDRT Core developers
 ...
 * Main network
 */
/** We used psztimestamp "Sov Coin" 8/13/2018 x16 alex jones banned from youtube
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 1 * 60; // SDRT: 1 hour
        consensus.nPowTargetSpacing = 1 * 60; // SDRT: 2 minutes
        ...
        nDefaultPort = 11019;
        nMaxTipAge = 6 * 60 * 60; // ~144 blocks behind -> 2 x fork detection time, was 24 * 60 * 60 in sdrt
   ...
   /*
     ...
     */
        ...
        vSeeds.push_back(CDNSSeedData("sdrt.hosthampster.com", "sdrt.hosthampster.com"));
        vSeeds.push_back(CDNSSeedData("sdrt1.hosthampster.com", "sdrt1.hosthampster.com"));
        ...
        // SDRT addresses start with 'S'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,63);
        // SDRT script addresses start with '8'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,18);
        // SDRT private keys start with 't'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128+63);
        // SDRT BIP32 pubkeys start with 'xpub' (SDRT defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // SDRT BIP32 prvkeys start with 'xprv' (SDRT defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // SDRT BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        strSporkPubKey = "04a0a5652fedcddbae0481c4cfeded5fc563f74c76ac249e1e57335cb7fbce7fd39cc10037169952ce7f3529b86f9d11cd0c8cb96423fce109ca963668997067d4";
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetTimespan = 30 * 60 * 2; // SDRT: 1 hour
        consensus.nPowTargetSpacing = 2 * 60; // SDRT: 2 minutes
       ...
       // assert(consensus.hashGenesisBlock == uint256S("0x00000ba049e5c1f95474ea3fc62d5f1b1632a294c20c22fea701134a43cf3068"));
        ...
        vSeeds.push_back(CDNSSeedData("testnet.sdrtproject.org", "testnet.seed.sdrtproject.org"));
        vSeeds.push_back(CDNSSeedData("fixed-seeds.sdrtproject.org", "testnet.fixed-seeds.sdrtproject.org"));
        // vFixedSeeds.clear();
        // vSeeds.clear();

        // Testnet SDRT addresses start with 'm'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,110);
        // Testnet SDRT script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,21);
        // Testnet private keys start with '9' or 'c' (SDRT defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet SDRT BIP32 pubkeys start with 'tpub' (SDRT defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet SDRT BIP32 prvkeys start with 'tprv' (SDRT defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet SDRT BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        strSporkPubKey = "04f10e7758ba66412ddaa7f8b7e6a8532e817d85b3b18d683a0091fa379e5f0f616405b5863ca275547838115827e2fe614ca4ec3d8a36e12db58309f888ae2af8";
...
public:
    CRegTestParams() {
       ...
       // assert(consensus.hashGenesisBlock == uint256S("0x000005ec6d48ac579d697448a82e93127b94403770629399cf561caa216a694b"));
        ...
        // Regtest SDRT addresses start with 'o'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,115);
        // Regtest SDRT script addresses start with 'a'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,83);
        // Regtest private keys start with '9' or 'c' (SDRT defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest SDRT BIP32 pubkeys start with 'tpub' (SDRT defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest SDRT BIP32 prvkeys start with 'tprv' (SDRT defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest SDRT BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
