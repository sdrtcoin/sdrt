...
#ifndef SDRT_TEST_SCRIPTNUM10_H
#define SDRT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from SDRT Core 0.10.0, for cross-comparison.
 */
public:
