...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CSDRTAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CSDRTAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CSDRTAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CSDRTAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CSDRTAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CSDRTAddress(arr[0].get_str()).Get() == demoAddress.Get());
