...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR) || dataDirDefaultCurrent != dataDirDefaultSettings)
    {
        ...
        intro.setWindowIcon(QIcon(":icons/sdrt"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SDRT Core"),
     ...
     * override -datadir in the sdrt.conf file in the default data directory
     * (to be consistent with sdrtd behavior)
     */
