...
#include "config/sdrt-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatSDRTURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + SDRTUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatSDRTURI(info));
}
