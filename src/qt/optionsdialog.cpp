    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SDRT-light"), QVariant("light"));
    ui->theme->addItem(QString("SDRT-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SDRT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SDRT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SDRT-traditional"), QVariant("trad"));
    ...
    ui->unit->setModel(new SDRTUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->sdrtAtStartup, OptionsModel::StartAtStartup);
