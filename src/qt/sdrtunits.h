...
#ifndef SDRT_QT_SDRTUNITS_H
#define SDRT_QT_SDRTUNITS_H
...
/** SDRT unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SDRTUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SDRTUnits(QObject *parent);

    /** SDRT units.
      @note Source: https://en.sdrt.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SDRT,
...
typedef SDRTUnits::Unit SDRTUnit;

#endif // SDRT_QT_SDRTUNITS_H
