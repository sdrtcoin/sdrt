...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(SDRTUnits::SDRT),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = SDRTUnits::floorWithUnit(unit, amount, true, SDRTUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(SDRTUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, SDRTUnits::separatorAlways));
    ui->labelUnconfirmed->setText(SDRTUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, SDRTUnits::separatorAlways));
    ui->labelImmature->setText(SDRTUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, SDRTUnits::separatorAlways));
    ui->labelAnonymized->setText(SDRTUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, SDRTUnits::separatorAlways));
    ui->labelTotal->setText(SDRTUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, SDRTUnits::separatorAlways));
    ui->labelWatchAvailable->setText(SDRTUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, SDRTUnits::separatorAlways));
    ui->labelWatchPending->setText(SDRTUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, SDRTUnits::separatorAlways));
    ui->labelWatchImmature->setText(SDRTUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, SDRTUnits::separatorAlways));
    ui->labelWatchTotal->setText(SDRTUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, SDRTUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("SDRT")
        updateDisplayUnit();
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = SDRTUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, SDRTUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), SDRTUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = SDRTUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, SDRTUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), SDRTUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(SDRTUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(SDRTUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
