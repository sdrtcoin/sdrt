 ...
 *
 *   // network
 *   CSDRTNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.sdrt.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSDRTNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SDRTNetwork
// //   -- signature requirements : Key1(User)
// class CSDRTNetworkVariable : public CGovernanceObject
// {
// private:
