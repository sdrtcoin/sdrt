...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("SDRT Core sdrt-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sdrt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sdrt transaction") + "\n" +
              "  sdrt-tx [options] -create [commands]   " + _("Create hex-encoded sdrt transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sdrt transaction
