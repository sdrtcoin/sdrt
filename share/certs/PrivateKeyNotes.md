...
unlocked to sign the SDRT-Qt.app bundle.
...
allowing somebody to distribute a SDRT-Qt.app or sdrt-qt-setup.exe with a valid
...
that the sdrt-qt.exe file inside the installer had not been tampered with.
