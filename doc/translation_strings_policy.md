...
This document provides guidelines for internationalization of the SDRT Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sdrt_en.ts` remains unchanged.
