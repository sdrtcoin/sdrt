...
SDRT Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- SDRTMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as SDRT Core, where everyone uses
...
pay attention to for reviewers of SDRT Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: SDRT Core uses tinyformat, which is type safe. Leave them out to avoid confusion
