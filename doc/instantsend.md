...
This mechanism has been integrated into Bitcore-Node-SDRT which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sdrtcrypto/insight-api-sdrt#web-socket-api](https://github.com/sdrtcrypto/insight-api-sdrt#web-socket-api)
* API: [https://github.com/sdrtcrypto/insight-api-sdrt#instantsend-transactions](https://github.com/sdrtcrypto/insight-api-sdrt#instantsend-transactions)
...
By default, the SDRT Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SDRT Core daemon:
